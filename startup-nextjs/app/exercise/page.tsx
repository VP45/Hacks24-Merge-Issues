  ...
  return (
    <>
      {/* <Link href="/chat/injury">
        <button
          className="fixed bottom-20 right-6 z-50 animate-bounce cursor-pointer rounded border-none bg-primary p-4 text-white outline-none hover:scale-105 hover:bg-violet-600"
