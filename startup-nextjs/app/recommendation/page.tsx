...
import { data, explanation } from "../../components/Recommendation/sampleResponse";

import Leg from "../../public/images/exercise/leg.png";
import Chest from "../../public/images/exercise/chest.png";
import Muscle from "../../public/images/exercise/muscle.png";
import Heart from "../../public/images/exercise/heart-beat.png";
import TypewriterText from "@/components/TypewriterText";
import WorkoutCard from "@/components/Recommendation/WorkoutCard";
                        ...
                        <div className="mb-6 lg:mb-0">
                            <div className="relative block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                                ...
                                <div className="p-6">
                                    ...
                                    <p
                                        // href={breakfast.link}
                                        className="inline-block rounded-full  px-4 py-1 text-xs font-normal uppercase leading-normal text-white bg-yellow m-0"
                                    >
                                        Breakfast
                                    </p>
                                </div>
...
const Recommendation = () => {
    ...
    return (
        <section className="flex flex-col gap-4 min-h-screen w-full p-4 mt-24">
